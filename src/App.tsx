        ...
        <div className="flex w-full max-w-6xl items-center justify-between px-4">
          ...
          <nav className="flex flex-col gap-1 text-right">
            <a
              ...
              className="inline-flex items-center gap-1.5 text-[11px] text-slate-300 hover:text-sky-300 md:text-xs"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 text-[11px] text-slate-300 hover:text-sky-300 md:text-xs"
            >
              <svg aria-hidden className="h-3.5 w-3.5 md:h-4 md:w-4" viewBox="0 0 24 24" fill="currentColor">
